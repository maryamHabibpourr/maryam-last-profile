...
export const Colors = ({ id }: CardProps) => {
  ...
  return (
    <FeatureCard id={id} gradient="from-[#f5fbff] to-[#addeff]">
       <img
        className={classNames(
          "absolute left-[2%] top-[10%] w-[60%] h-[45%] rounded-xl shadow-lg transition-transform",
      ...
      <img
        className={classNames(
          "absolute left-[35%] top-[20%] w-[60%] h-[38%] rounded-xl shadow-lg transition-transform",
          isFullscreen ? "scale-0" : "scale-100"
        )}
        src={ tee3}
      />
      <img
        className={classNames(
          "absolute left-[10%] top-[60%] w-[80%] h-[39%] rounded-xl shadow-lg transition-transform",
          isFullscreen ? "scale-0" : "scale-100"
        )}
        src={ tee2}
      />
      ...
      {!isFullscreen && (
        <motion.div
          ...
          className="absolute left-[40%] top-32 h-48 w-20 rounded-[96px] bg-[#1bd761] p-3 shadow-lg"
        >
...
export const Availability = ({ id }: CardProps) => {
  ...
  return (
    <FeatureCard id={id} gradient="from-[#f5fff7] to-[#adf8ff]">
      <img
        className={classNames(
          "absolute left-[2%] top-[10%] w-[50%] h-[40%] rounded-xl shadow-lg transition-transform",
          isFullscreen ? "scale-0" : "scale-100"
        )}
        src={shop1}
      />
      <img
        className={classNames(
          "absolute left-[50%] top-[20%] w-[47%] h-[40%] rounded-xl shadow-lg transition-transform",
          isFullscreen ? "scale-0" : "scale-100"
        )}
        src={ shop2}
      />
      <img
        className={classNames(
          "absolute left-[20%] top-[60%] w-[70%] h-[40%] rounded-xl shadow-lg transition-transform",
          isFullscreen ? "scale-0" : "scale-100"
        )}
        src={ shop3}
      />
...
export const Music = ({ id }: CardProps) => {
  ...
  return (
    <FeatureCard id={id} gradient="from-[#f7fff5] to-[#adffd8]">
      ...
      <img
        className={classNames(
          "absolute left-[45%] top-[20%] w-[50%] h-[30%] rounded-xl shadow-lg transition-transform",
          isFullscreen ? "scale-0" : "scale-100"
        )}
        src={amlak2}
      />
